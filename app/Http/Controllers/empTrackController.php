...
class empTrackController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('empTrack.index', compact('users', 'withdraws' , 'withdrawdetails' , 'materials' , 'departments' ));
    ...
    public function show($id)
    {
        ...
        return view('empTrack.show',compact( 'withdrawdetail' , 'withdraw','material','category' , 'department'));
    }
