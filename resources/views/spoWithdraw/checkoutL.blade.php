                ...
                <div class="col-lg-12">
                    <div class="card card-orange card-outline">
                        <div class="card-body">
                            ...
                            @php $total = 0 @endphp
                            @foreach ((array) session('withdraw') as $id => $details)
                                                    ...
                                                    @foreach ($withdrawdetail as $item)
                                                        ...
                                                        <form>
                                                            <tr data-id="check_withdraw">
                                                                ...
                                                                <td>
                                                                    <input class="form-control " type="text"
                                                                        id="mate_amount" name="mate_amount"
                                                                ...
                                                                <td data-th="checkout_amount">
                                                                    <input type="int" name="checkout_amount"
                                                                        id="checkout_amount" type="hidden" {{ old('amount', $item->amount ?? '') }} 
                                                                         
                                                                        min="0"
                                                                        max="{{ $item->material->mate_amount ?? '' }}"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="font-size: 16px;width: 230px">
                                                                <input class="form-control text-right" type="text"
                                                                    id="grand_total" name="grand_total"
                                                                    value=" {{ $total }}   รายการ" readonly> <br>
                                                                {{ Auth::user()->name ?? '' }} <br>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="approve_success" value="0" class="form-control"
                                    id="approve_dir">
                                <input type="hidden" name="checkout_amount" class="form-control" id="checkout_amount">
