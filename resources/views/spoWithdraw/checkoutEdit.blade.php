...
@section('content')
                            ...
                            <div class="card border-0 shadow-sm">
                                        ...
                                        <table id="Checkout" name=" Checkout " class="table table-hover table-white">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($withdrawdetail as $item)
                                                    <tr data-id="check_withdraw[]"  name="check_withdraw[]" >
                                                        <td> {{ $i++ ?? '' }} </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                                <input class="form-control total" style="width:100px"
                                                                    type="text" id="note" name="note" value="{{ $item->note ??'' }}" >
                                                            </td>
                                                    </tr>
                                                @endforeach
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td colspan="5"
                                                                ...
                                                                <span class="text-primary" > มูลค่ารวมทั้งสิ้น </span> <span class="text-danger">*</span>
                                                            </td>

                                                            <td style="font-size: 16px;width: 230px">
                                                                <input class="form-control text-right" type="text"
                                                                    id="grand_total" name="grand_total"
                                                                    value="{{ number_format($total, 2 ) ??'' }} บาท " readonly> <br>
                                                                {{ Auth::user()->name ?? '' }} <br>
                                ...
                                <div class="modal-footer">
                                    <button href="#checkoutNo" data-toggle="modal" type="submit"
                                        ...
                                        ไม่อนุมัติ </button>
                                    <a href="{{ route('withdraw.checkUp', $item->id ??'') }} " type="submit"
                            ...
                            <div class="row form-row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="hidden" name="check_withdraw[]" class="form-control"
                                        id="">
    ...
    <!-- Add Modal checkedit -->
    <form action="{{ route('withdraw.checkUp', $item->id ?? '') }} " method="POST" enctype="multipart/form-data"><br>
        @csrf
        @method('PUT')
                                            ...
                                            @endphp
                                                ...
                                                <input type="hidden" name="material_id[]" value="{{$item->id ??'' }}">
                                                        <tr data-id=" ">
                                                            ...
                                                            <td data-th="Amount">
                                                                <input type="text" name="old_amount[]"
                                                                    value="{{ $item->amount ?? '' }} "
                                                                    class="form-control amount" readonly />
                                                            </td>
                                                            <td data-th="Amount">
                                                                <input   type="int" id="amount" name="amount[]"
                                                                value="{{ $item->pivot->amount ?? '' }} "
                                                                    class="form-control checkout_amount update-cart" />
                                                            </td>
                                                            <td>
                                                                <input class="form-control total" style="width:100px"
                                                                    type="text" id="material_id" name="mate_unit[]"
                                            ...
                                            <table class="table table-hover table-white">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control text-right total" type="text"
                                                                id="sum_total" name="total" value=" {{ count($withdrawdetail) ??''  }}  รายการ "
                                                                readonly>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size: 16px;width: 230px">
                                                            <input class="form-control text-right" type="text"
                                                                id="grand_total" name="grand_total" value=" {{ count($withdrawdetail) ??''  }} รายการ"
                                                                readonly>
                                                        </td>
